...
export async function loader({ context }: any) {
  ...
  if (!env.X_CLIENT_ID || !env.X_REDIRECT_URI) throw new Response("X OAuth is not configured", { status: 500 });
  ...
  return redirect(url.toString(), {
    headers: {
      "Set-Cookie": `plurmurate_oauth=${state}.${verifier}; Path=/; HttpOnly; SameSite=Lax; Secure; Max-Age=600`,
    },
  });
}
